...
```{r, message=FALSE, warning=FALSE, echo=FALSE, fig.width=2, fig.height=1}

htmltools::img(src = knitr::image_uri(file.path("D:/OD/Documents/UU Logo.svg")), 
               alt = 'logo', 
               style = 'position:absolute; top:15px; right:40px; padding:10px;')
```
